...
export const DashboardBookCard: React.FC<BookDataType> = ({ ...item }) => {
  ...
  // To return and update the book status
  const { sendGetBookRequest } = useGetBRBooks();
